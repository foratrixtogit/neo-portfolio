...
const PROJECTS = [
  {
    ...
    img: '/foto/projects/crudlaravel.png', // dari public
  ...
  },
  {
    ...
    img: '/foto/projects/gamepesawat.jpg',
    tags: ['C#', '.NET'],
    live: '#',
    repo: '#'
  },
  {
    ...
    img: '/foto/projects/perpustakaan.jpg',
    ...
    <section id="projects" className="section">
      <div className="container">
        ...
        <div className="text-center mt-8">
          <a
            href="https://github.com/foratrixtogit"
            target="_blank"
            rel="noreferrer"
